...
class AipSpeech(AipBase):
    ...
    async def asr(self, speech=None, format='wav', rate=16000, options=None):
        """
            语音识别
        """
        ...
        return await self._request(self.__asrUrl, data)

    async def synthesis(self, text, lang='zh', ctp=1, options=None):
        """
            语音合成
        """
        data ={}
        ...
        result = await self._request(self.__ttsUrl, data)
